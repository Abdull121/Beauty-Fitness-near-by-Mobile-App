...
export class AuthService {
    ...
    appwriteConfig = {
        ...
        userRegistrationCollection: Constants.expoConfig.extra.USER_REGESTRATION_COLLECTION,
  ...
  console.log("Creating admin account with username:", username, "email:", formattedEmail);
...
async createUserAccount({ username, email, password }) {
  ...
  console.log("Creating user account with username:", username, "email:", formattedEmail);
  ...
  try {
    ...
    async  getAccount() {
        ...
        //         this.appwriteConfig.appwriteDatabaseId,
        //         this.appwriteConfig.userBookingCollection,
